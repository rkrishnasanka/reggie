...
graphstatement:basestatement | ('(' basestatement ')' statementmodifier);
...
vertex: structuralid(':'labelfilter)? coloringfilter? structuralvertexpattern*;

coloringfilter: '{' STRING (',' STRING)* '}';

structuralvertexpattern:  (intmodifier | starmodifier | plusmodifier)  ;
...
//ARROW: '->';
//STAR_WILDCARD: '*'; //Not used to describe any label but rather
//PLUS_WILDCARD: '+';
